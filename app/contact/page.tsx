...
const contactInfo = [
  {
    icon: Phone,
    title: "Téléphone",
    details: "+237 699 412 460",
    subtitle: "Orange Money disponible",
  },
  {
    icon: Mail,
    title: "Email",
    details: "mholistichealthcenter@gmail.com",
    subtitle: "Réponse sous 24-48h",
  },
  {
    icon: MapPin,
    title: "Compte Bancaire",
    details: "679 012 650 01",
    subtitle: "Pour vos dons et contributions",
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
              Une question ? Besoin d&apos;accompagnement ? Nous sommes là pour vous écouter.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            <Card>
              <CardHeader>
                <CardTitle className="text-lg md:text-xl">Envoyez-nous un message</CardTitle>
              </CardHeader>
              <CardContent>
